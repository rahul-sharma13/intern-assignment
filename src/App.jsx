...
const App = () => {
  ...
  // to handle the changes made in the input form
    ...
    <section className='h-screen bg-black flex flex-col items-center justify-center'>
      {
        Object.keys(error).length === 0 && submit ? (
          <div className='text-white flex flex-col items-center justify-center gap-2'><h1 className='text-lg text-white/60'>registered successfully</h1>
            ...
            {checkbox && <h2 className='text-sm'>guest name is : {formData.guestName}</h2>}
          </div>
        )
          :
          (
            <div className='flex flex-col justify-center items-center gap-2'>
              ...
              <div className=''>
                <form className='w-[500px] h-[500px] bg-slate-800 flex flex-col items-center justify-center gap-3' onSubmit={handleSubmit}>
                  <input
                    placeholder="Name"
                    id="name"
                  ...
                  <label
                    className="has-[:checked]:bg-white/30 has-[:checked]:text-[#292929] has-[:checked]:ring-[#292929] has-[:checked]:ring-2 cursor-pointer bg-white/40 hover:bg-white/20 w-72 p-4 rounded-md flex justify-between items-center shadow"
                  >
